...
cf_mlp_embed = {"method_wat": method_wat,
                ...
                "save_path": "results/watermarked_models/stdm/"+cf_mlp_dict['architecture'].lower() + "/"
                             + save_path_embed + ".pth",
...
cf_mlp_attack_ft = {"configuration": cf_mlp_dict,
                    ...
                    "device": cf_mlp_dict["device"],
                    "save_path": "results/attacks/finetuning/stdm/" + cf_mlp_dict[
                        "architecture"].lower() + "/" + save_path_attack + ".pth",

                    "save_fig_path": "results/attacks/finetuning/stdm/" + cf_mlp_dict[
                        "architecture"].lower() + "/" + save_path_attack + ".png",
                    "x_label": "Partition_SpreadTransformDitherModulation_" + cf_mlp_dict["architecture"].lower(),
                    "y_label": "BER/ACC",
...
cf_mlp_attack_pr = {"configuration": cf_mlp_dict,
                    ...
                    "device": cf_mlp_dict["device"],
                    "architecture": cf_mlp_dict["architecture"],
                    "save_path": "results/attacks/pruning/stdm/" + cf_mlp_dict[
                        "architecture"].lower() + "/" + save_path_attack + ".pth",
                    }
...
cf_mlp_attack_ow = {"configuration": cf_mlp_dict,
                    ...
                    "criterion": cf_mlp_dict["criterion"],
                    "device": cf_mlp_dict["device"],
                    "save_fig_path": "results/attacks/overwriting/stdm/" + cf_mlp_dict[
                        "architecture"].lower() + "/" + save_path_attack + ".png",
                    "x_label": "Partition_SpreadTransformDitherModulation" + cf_mlp_dict["architecture"].lower(),
                    "y_label": "BER/ACC",
                    "show_acc_epoch": False,
                    "alpha": cf_mlp_embed["alpha"],
                    "beta": cf_mlp_embed["beta"],
                    }
cf_mlp_attack_pia = {}
...
cf_cnn_embed = {"method_wat": method_wat,
                ...
                "save_path": "results/watermarked_models/stdm/" + cf_cnn_dict['architecture'].lower() + "/"
                             + save_path_embed + ".pth",
...
cf_mlp_riga_embed = {"method_wat": method_wat,
                    "configuration": cf_mlp_riga_dict,
                     ...
                     "save_path": "results/watermarked_models/stdm/" + cf_mlp_riga_dict['architecture'].lower() + "/"
                                  + save_path_embed + ".pth",
...
cf_mlp_riga_attack_ft = {"configuration": cf_mlp_riga_dict,
                         ...
                         "device": cf_mlp_riga_dict["device"],
                         "save_path": "results/attacks/finetuning/stdm/" + cf_mlp_riga_dict[
                             "architecture"].lower() + "/" + save_path_attack + ".pth",

                         "save_fig_path": "results/attacks/finetuning/stdm/" + cf_mlp_riga_dict[
                             "architecture"].lower() + "/" + save_path_attack + ".png",
                         "x_label": "Partition_SpreadTransformDitherModulation_" + cf_mlp_riga_dict["architecture"].lower(),
                         "y_label": "BER/ACC",
                         "show_acc_epoch": False
                         }
...
cf_mlp_riga_attack_pr = {"configuration": cf_mlp_riga_dict,
                         ...
                         "device": cf_mlp_riga_dict["device"],
                         "architecture": cf_mlp_riga_dict["architecture"],
                         "save_path": "results/attacks/pruning/stdm/" + cf_mlp_riga_dict[
                             "architecture"].lower() + "/" + save_path_attack + ".pth",
                         }
...
cf_mlp_riga_attack_ow = {"configuration": cf_mlp_riga_dict,
                         ...
                         "save_path": "results/watermarked_models/stdm/" + cf_mlp_riga_dict[
                             'architecture'].lower() + "/"
                                      + save_path_embed + ".pth",
                         ...
                         "criterion": cf_mlp_riga_dict["criterion"],
                         "device": cf_mlp_riga_dict["device"],
                         "save_fig_path": "results/attacks/overwriting/stdm/" + cf_mlp_riga_dict[
                             "architecture"].lower() + "/" + save_path_attack + ".png",
                         "x_label": "Partition_SpreadTransformDitherModulation" + cf_mlp_riga_dict["architecture"].lower(),
                         "y_label": "BER/ACC",
                         "show_acc_epoch": False
                         }

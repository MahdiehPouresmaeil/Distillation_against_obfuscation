...
from configs.cf_data.cf_data import cf_cifar10_data,cf_mnist_data
...
cf_vae_dict = {"batch_size": batch_size, "lr": 1e-3, "epochs": epochs, "wd": 1e-4, "opt": "Adam",
               ...
               "save_path": "results/trained_models/" + architecture.lower() + "/_db" + database + "_ep" + str(epochs)
                            + "_bs" + str(batch_size) + "_filters_0128_dims_0064" + ".pth",
               "save_fig_path": "results/trained_models/" + architecture.lower() + "/_db" + database
                                + "_ep" + str(epochs) + "_bs" + str(batch_size)+ "_filters_0128_dims_0064",
               "show_acc_epoch": True}
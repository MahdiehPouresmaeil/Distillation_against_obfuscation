...
# Data configuration
from configs.cf_data.cf_data import cf_mnist_data, cf_cifar10_data, cf_cifar100_data, cf_flower102_data, cf_stl10_data

# Model configurations
from configs.cf_train.cf_cnn import cf_cnn_dict, cf_cnn2_dict, cf_cnn_flower102_dict
...
method_configurations = {
    ...
    'DICTION2': 'configs.cf_watermark.cf_diction2',
    ...
    'PASSPORT': 'configs.cf_watermark.cf_passport',
    'GREEDY': 'configs.cf_watermark.cf_greedy',
    'LAPLACIAN': 'configs.cf_watermark.cf_laplacian_dis',
}
...
model_configurations = {
    ...
    'CNN': (cf_cnn_dict, cf_cifar10_data, 'cf_cnn_embed', 'cf_cnn_attack_ft', 'cf_cnn_attack_pr', 'cf_cnn_attack_ow',
            'cf_cnn_attack_pia', 'cf_cnn_attack_dummy_neurons', 'cf_cnn_attack_distillation','cf_cnn_attack_ambiguity'),
    # 'CNN_cifar100': (cf_cnn2_dict, cf_cifar100_data, 'cf_cnn_embed', 'cf_cnn_attack_ft', 'cf_cnn_attack_pr', 'cf_cnn_attack_ow',
    #         'cf_cnn_attack_pia', 'cf_cnn_attack_dummy_neurons', 'cf_cnn_attack_distillation', 'cf_cnn_attack_ambiguity'),
    # 'CNN': (cf_cnn_dict, cf_stl10_data, 'cf_cnn_embed', 'cf_cnn_attack_ft', 'cf_cnn_attack_pr', 'cf_cnn_attack_ow',
    #         'cf_cnn_attack_pia', 'cf_cnn_attack_dummy_neurons', 'cf_cnn_attack_distillation','cf_cnn_attack_ambiguity'),
    'RESNET18': (cf_resnet18_dict, cf_cifar10_data, 'cf_resnet18_embed', 'cf_resnet18_attack_ft',
                 ...
                 'cf_resnet18_attack_dummy_neurons', 'cf_resnet18_attack_distillation','cf_cnn_attack_ambiguity'),
    ...
    'VAE': (cf_vae_dict, cf_cifar10_data, 'cf_vae_embed', 'cf_vae_attack_ft', 'cf_vae_attack_pr', 'cf_vae_attack_ow',
            'cf_vae_attack_pia', 'cf_vae_attack_dummy_neurons', 'cf_vae_attack_distillation','cf_vae_attack_ambiguity'),
    'VGG16': (cf_vgg16_dict, cf_cifar10_data, 'cf_vgg16_embed', 'cf_vgg16_attack_ft', 'cf_vgg16_attack_pr', 'cf_vgg16_attack_ow',
            'cf_vgg16_attack_pia', 'cf_vgg16_attack_dummy_neurons', 'cf_vgg16_attack_distillation','cf_vgg16_attack_ambiguity'),
}
...
config_train, config_data, embed_name, ft_name, pr_name, ow_name, pia_name, dn_name, dt_name, ambiguity_name =  model_configurations[model]
...
config_attack_ambiguity=globals()[ambiguity_name]
# Tests configuration
...
if __name__ == '__main__':
    ...
    print("memory state before cleaning:")
    Util.print_gpu_memory()
    torch.cuda.empty_cache()
    gc.collect()
    print("memory state after cleaning:")
    Util.print_gpu_memory()
    ...
    if operation == "TRAIN":
        ...
        print("\n---------------------- Overwriting attack -----------------------------\n")
        if method == "HUFUNET":
            _tests.overwriting_attack_hufu(config_embed, config_attack_ow, config_data)
        else:
        ...
        if method == "HUFUNET":
            ...
            runtime_gen_db = datetime.datetime.now() - t_start_gen_db
            print(f"runtime_wm to Distillation : {runtime_gen_db} ")
    elif operation== "AMBIGUITY":
        print("\n---------------------- Ambiguity  attack -----------------------------\n")
        _tests.ambiguity_attack( config_embed=config_embed, config_attack=config_attack_ambiguity, config_data=config_data)
    else:
        print(f"Unknown operation: {operation}")
        print("Available operations: TRAIN, WATERMARKING, TRAIN-WATERMARKING,  FINE_TUNING, PRUNING, OVERWRITING, PIA, SHOW, DUMMY_NEURONS, DISTILLATION")

    print("memory state after training:")
    Util.print_gpu_memory()